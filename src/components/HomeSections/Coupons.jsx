            ...
            <div className="flex-grow border-2 border-l-0 border-dashed px-4 py-2 relative">
              ...
              >
                <button
                  ...
                  className="btn bg-accent text-white font-normal text-sm md:text-base btn-sm mt-2 hover:bg-primary hover:text-white border-transparent border hover:border-primary"
                >
