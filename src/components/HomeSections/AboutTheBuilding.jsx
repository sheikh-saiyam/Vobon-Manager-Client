    ...
    <div>
      ...
      <div className="flex flex-col-reverse gap-6 xl:flex xl:flex-row-reverse justify-between items-center mt-8">
        ...
        <div className="w-full xl:w-7/12">
          <p className="text-text dark:text-white tracking-wider text-center text-lg">
          ...
          <div className="mt-6 flex flex-col sm:grid grid-cols-4 md:grid-cols-5 gap-6 h-full">
            ...
            <div className="bg-red-100/5 dark:bg-[#1b1b1b] dark:border-none dark:shadow-none border-secondary border shadow shadow-secondary col-span-2 md:col-span-3 p-4 rounded-lg grid place-content-stretch">
              ...
              <p className="text-gray-500 dark:text-[#ececec] text-sm md:text-base">
                Crafted with eco-friendly features and energy-efficient systems,
                ensuring optimal performance.
              </p>
            </div>
            {/* An Architectural Gem */}
            <div className="bg-red-100/5 dark:bg-[#1b1b1b] dark:border-none dark:shadow-none border-secondary border shadow shadow-secondary col-span-2 md:col-span-2 p-4 rounded-lg grid place-content-stretch">
              ...
              <p className="text-gray-500 dark:text-[#fff] text-sm md:text-base">
            ...
            <div className="bg-red-100/5 dark:bg-[#1b1b1b] dark:border-none dark:shadow-none border-secondary border shadow shadow-secondary col-span-2 md:col-span-2 p-4 rounded-lg grid place-content-stretch">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <div className="text-4xl mb-4">
                  <FaCog className="text-gray-500 dark:text-[#fff]" />
                </div>
                <h3 className="text-base dark:text-white md:text-lg lg:text-xl font-semibold text-gray-700 mb-2">
                  State-of-the-Art Facilities
                </h3>
        ...
        {/* image container */}
        <div className="w-full xl:w-5/12 dark:bg-white dark:p-2 dark:rounded">
